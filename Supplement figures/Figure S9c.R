...
######################################## stats and plot
  ...
  sub1 <- subset(data, Organism == "Fungi")
  ...
  label_data_clean <- label_data_clean %>%
    mutate(CL_label = ifelse(Factor == "Root_type" & Metric == "Observed", NA, CL_label))
  
  ########## reassign letters so letter of first level is a
  label_data_clean <- label_data_clean %>%
    mutate(CL_label = case_when(
      Factor == "Root_section" & Metric == "Observed" & Level == "base" ~ "b",
      Factor == "Root_section" & Metric == "Observed" & Level == "tip" ~ "c",
      Factor == "Root_section" & Metric == "Observed" & Level == "bulk" ~ "a",
      Factor == "Root_section" & Metric == "Pielou" & Level == "base" ~ "b",
      Factor == "Root_section" & Metric == "Pielou" & Level == "tip" ~ "c",
      Factor == "Root_section" & Metric == "Pielou" & Level == "bulk" ~ "a",
      Factor == "X11C_level" & Metric == "Pielou" & Level == "low" ~ "b",
      Factor == "X11C_level" & Metric == "Pielou" & Level == "medium" ~ "c",
      Factor == "X11C_level" & Metric == "Pielou" & Level == "high" ~ "d",
      TRUE ~ CL_label
    ))
...
png("Figure S9c.png", width = 300, height = 300, units = "mm", res = 1000)
